...
public class BloodFactsAdapter extends RecyclerView.Adapter<BloodFactsAdapter.BloodFactViewHolder> {
    ...
    public BloodFactsAdapter(ActivityBloodFacts activityBloodFacts, List<String> values, boolean aBooleans,String aBoolean) {
    ...
    public BloodFactsAdapter(ActivityBloodFacts activityBloodFacts, List<String> valuesmyth, List<String> valuefacts, boolean aBooleans,String aBoolean) {
        activity = activityBloodFacts;
        datamyth = valuesmyth;
